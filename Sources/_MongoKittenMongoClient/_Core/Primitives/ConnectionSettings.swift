...
public struct ConnectionSettings: Equatable 
{
    ...
    public 
    var authentication:Mongo.Authentication
    ...
    init(authentication:Mongo.Authentication, 
        ...
        maximumNumberOfConnections:Int = 1, 
        connectTimeout:TimeInterval = 300, 
        socketTimeout:TimeInterval = 300, 
    ...
    public init(_ uri: String) throws {
        ...
        self.hosts = try hostsPart.split(separator: ",").map 
        { 
            try Mongo.Host.init(parsing: $0, srv: isSRV) 
        }
