...
//             switch self 
//             {
//             case .shape(let shape): return shape.plural
//             }
//         }
        
//         static 
//         let allCases:[Self] = Shape.allCases.map(Self.shape(_:))
//     }
...
//     {
//         let sublist:Sublist = .shape(self.ecosystem[composite.base].shape)
