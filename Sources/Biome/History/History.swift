...
//                     let index:Index = self.history.rewind(future, to: epoch.latest.revision)
//                 {
//                     return (epoch, index) 
//                 }
//             }
...
//             {
//                 if  let index:Index = self.history.rewind(head, to: epoch.latest.revision)
//                 {
//                     return (epoch, index)
//                 }
//                 else 
...
//             }
//             if let index:Index = self.history.rewind(head, to: divergences.latest.revision)
//             {
...
//     }
//     mutating 
//     func update<Element>(_ buffer:inout IntrinsicBuffer<Element>, 
