...
extension Biome 
{
    struct ArticleRenderer 
    {
        ...
        mutating 
        func render<ID>(code:[Language.Lexeme], anchors _:ID.Type = ID.self) -> [HTML.Element<ID>] 
        {
            code.map 
            {
        ...
        mutating 
        func render<ID>(lexeme:Language.Lexeme, anchors _:ID.Type = ID.self) -> HTML.Element<ID>
        {
        ...
        mutating 
        func render(declaration:[Language.Lexeme]) -> StaticElement
        {
